            ...
            <div class="card mt-3 row">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('venta.update', $venta) }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12 mb-5">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_cliente" id="id_cliente">
                                    ...
                                    <option value="{{ $cliente->id }}" {{ old('id_cliente', $venta->
                                        id_cliente)==$cliente->id ? 'selected' : ''
                            ...
                            <div class="col-sm-4 mb-5">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_servicio" id="id_servicio">
                                    <option value="" {{ old('id_servicio', $venta->id_servicio)}}>Seleccione un servicio
                                    </option>
                                    @foreach ($servicio as $servicio)
                                    <option value="{{ $servicio->id }}" {{ old('id_servicio', $venta->
                                        id_servicio)==$servicio->id ? 'selected' :
                            ...
                            <div class="col-sm-4 mb-4">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_auto" id="id_auto">
                                    ...
                                    <option value="{{ $auto->id }}" {{ old('id_auto', $venta->id_auto)==$auto->id ?
                                        'selected' : '' }}>{{
                            ...
                            <div class="col-sm-4 mb-4">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="tipo_auto" id="tipo_auto">
                                    <option {{ old('tipo_auto', $venta->tipo_auto) }} selected>Seleccione el tipo de
                                        vehiculo</option>
                                    <option value="1" {{ old('tipo_auto', $venta->tipo_auto)== 1 ? 'selected' : ''
                                        }}>Auto</option>
                                    <option value="2" {{ old('tipo_auto', $venta->tipo_auto)== 2 ? 'selected' : ''
                                        }}>Camioneta
                                    </option>
                                    <option value="3" {{ old('tipo_auto', $venta->tipo_auto)== 3 ? 'selected' : ''
                                        }}>Minivan
                                    </option>
                                    <option value="4" {{ old('tipo_auto', $venta->tipo_auto)== 4 ? 'selected' : ''
                                        }}>Van</option>
                                </select>
                            ...
                            <div class="col-sm-12 mb-4">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_e_supervisor" id="id_e_supervisor">
                                    ...
                                    <option value="{{ $e_supervisor->id }}" {{ old('id_e_supervisor', $venta->
                                        id_e_supervisor)==$e_supervisor->id ?
                                        'selected' : '' }}>{{ $e_supervisor->nombre }} {{ $e_supervisor->ap_paterno}} {{ $e_supervisor->ap_materno}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-4 mb-5">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_e_operario1" id="id_e_operario1">
                                    ...
                                    <option value="{{ $e_operario1->id }}" {{ old('id_e_operario1', $venta->
                                        id_e_operario1)==$e_operario1->id ?
                                        'selected' : '' }}>{{
                                        $e_operario1->cargo }}: {{ $e_operario1->nombre }} {{ $e_operario1->ap_paterno }} {{ $e_operario1->ap_materno }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-4 mb-5">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_e_operario2" id="id_e_operario2">
                                    ...
                                    <option value="{{ $e_operario2->id }}" {{ old('id_e_operario2', $venta->
                                        id_e_operario2)==$e_operario2->id ?
                            ...
                            <div class="col-sm-4 mb-5">
                                ...
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="id_e_operario3" id="id_e_operario3">
                                    ...
                                    <option value="{{ $e_operario3->id }}" {{ old('id_e_operario3', $venta->
                                        id_e_operario3)==$e_operario3->id ?
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                <input type="number" class="form-control" readonly="readonly" name="subtotal" id="subtotal" value="{{ old('subtotal', $venta->subtotal) }}" />
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                <input type="number" class="form-control" readonly="readonly" name="igv" id="igv" value="{{ old('igv', $venta->igv) }}" />
                                @if ($errors->first("igv"))
                                <br />
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    {{ $errors->first("igv") }}
                            ...
                            <div class="col-sm-3 mb-3">
                                ...
                                <input type="number" class="form-control" readonly="readonly" name="total" id="total" value="{{ old('total', $venta->total) }}" />
                        ...
                        <button type="submit" class="btn btn-outline-primary" onclick="comprobarinputs()" >Guardar Cambios</button>
                    </form>
                </div>
            </div>
        </article>
